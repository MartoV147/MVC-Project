...
namespace SharedTravel.Migrations
{
    ...
    [Migration("20210607165614_InitialMigration")]
            ...
            modelBuilder.Entity("SharedTravel.Models.Travel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArrivalTime = new DateTime(2021, 6, 7, 19, 56, 14, 338, DateTimeKind.Local).AddTicks(5906),
                            CityFrom = "Plovdiv",
                            CityTo = "Sofia",
                            CreatorId = 2,
                            DepartureTime = new DateTime(2021, 6, 7, 19, 56, 14, 333, DateTimeKind.Local).AddTicks(2474),
                            FreeSeatsCount = 4,
                            Price = 5m
                        });
                });
